...
npm run build
npx pm2 describe code-ai-app
npx pm2 logs code-ai-app
npx pm2 restart code-ai-app
```
...
PM2 reads its app name and port from `.env`; ambient shell variables do not override them.
