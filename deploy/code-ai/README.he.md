...
- **מצב עיצוב Codex × Gemini** שבו Gemini מספק שיקול דעת חזותי וקודקס נשאר האחראי הבלעדי לקוד, ללוגיקה וליכולות; בכל ייעוץ קודקס מחליט אם להשמיט את הקנבס, לשלוח אותו במלואו או לשלוח חיתוך ממוקד.
- **מצב חוויית משתמש Codex × Gemini** שבו Codex שומר עמדה פרטית, Gemini מחזיר נקודת פתיחה עצמאית בלי לראות אותה, ורק אז מתקיימים עד עשרה חילופי טיעון־נגד לפני זיקוק מוצרי מפורק לפי שלבי הלקוח.
...
- לפתוח קנבס ציור ולהפעיל מצב עיצוב רק בסשן שבו נדרש שיתוף פעולה חזותי בין Codex ל־Gemini
- להפעיל מצב חוויית משתמש רק בסשן שדורש ניתוח מסע לקוח, אמון, כלכלה התנהגותית, פסיכולוגיה, חיכוך או היררכיה חזותית
...
- `skills/` — תהליכי מומחה סשן־סקופיים שנחשפים רק על ידי המצב שמפעיל אותם
