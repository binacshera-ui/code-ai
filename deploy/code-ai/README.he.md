...
- **מצב פרויקט UI/Product** שמחייב פורט UI פתוח, תיקיות frontend/backend ובריף מוצר, משתמשים ומותג מלא; לאחר האימות הוא מפעיל תוכנית Codex רב־סוכנית עם מועצות Gemini UX ו־Design.
