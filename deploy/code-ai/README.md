...
- Project Mode: a validated live UI port plus product, audience, brand, typography, palette, frontend and backend inputs launch a resumable Codex-agent program with managed Gemini UX and Design councils.
...
- activating Project Mode only after its UI port and source roots pass validation, then running a staged product, design, implementation, critique, and verification program
